...
각 주차는 **강의노트(md) 1개 + 인포그래픽(svg) 2개** 로 구성되며, Obsidian Vault에서 wikilink 임베드로 작동합니다.
...
각 주차 강의노트는 **2개의 인포그래픽 SVG**를 Obsidian wikilink(`![[…svg]]`)로 임베드합니다. Obsidian에서 열면 자동 렌더링되며, VS Code·GitHub 웹에서도 동일 폴더에 있어 링크가 작동합니다.
